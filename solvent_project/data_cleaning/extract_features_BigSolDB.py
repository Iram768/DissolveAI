...
# Paths
input_csv = "data_processed/BigSolDB_clean.csv"   # change for BigSolDB_clean.csv
output_csv = "features/BigSolDB_features_numeric.csv"
...
# df = pd.read_csv("features/BigSolDB_features_numeric.csv")
