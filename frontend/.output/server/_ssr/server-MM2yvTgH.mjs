...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-MM2yvTgH.js
var server_MM2yvTgH_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } =
    await import("../_tanstack-start-manifest_v-CxeR4cV_.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DkXKgi1X.mjs").then((n) => n.t),
...
export {
  ...
  createMiddleware as r,
  server_MM2yvTgH_exports as t,
};
